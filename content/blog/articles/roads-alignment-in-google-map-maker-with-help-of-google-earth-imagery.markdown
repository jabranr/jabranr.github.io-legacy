...
<img src="{{ '/assets/images/bhratian-road-correction.jpg' | prepend: site.baseurl }}" alt="Bhratian Road Correction" class="img-responsive">
...
<img src="{{ '/assets/images/google-earth-road-drawing.jpg' | prepend: site.baseurl }}" alt="Google Earth Road Drawing" class="img-responsive">
...
<img src="{{ '/assets/images/save-kml-to-google-maps-mymaps.jpg' | prepend: site.baseurl }}" alt="Saving KML To Google Maps" class="img-responsive">
